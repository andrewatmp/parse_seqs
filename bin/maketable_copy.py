...
def make_taxa_table(input_file, output_file, sample_name):
    ...
    domain_pie = dict(x=[0, 1], y=[0, 1])  # Adjust domain to make pie chart bigger
    ...
    fig.add_trace(go.Table(
        header=dict(values=['Genus and Species', 'Relative Abundance (%)'],
...
if __name__ == "__main__":
    ...
    make_taxa_table(args.input_file, args.output_file, args.sample_name)
